...
import { BytebankButton, BytebankCard } from '@repo/ui';
import SecurityIcon from '@mui/icons-material/Security';
import { FilterVintage, FlashOn } from '@mui/icons-material';
function App() {
  return (
        ...
        <Box display={"flex"} flexDirection="column" alignItems="center" justifyContent="center" minHeight="100vh" >
          <Box textAlign={"center"}>
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
              Este é a aplicação Microfrontend de Investimentos do Bytebank
            </h1>

            {/* Subtitle */}
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Uma solução moderna e elegante para gerenciamento de componentes de investimentos
            </p>
