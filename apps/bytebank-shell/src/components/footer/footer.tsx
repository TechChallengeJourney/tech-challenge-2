  ...
  const loggedTemplate = () => (
    <>
      <Box
        ...
        textAlign={"center"}
      >
        <Typography id="bytebank-footer-text">
  ...
  const unloggedTemplate = () => (
    <>
      ...
      >
        ...
        <Typography>meajuda@bytebank.com.br</Typography>
        <Typography>ouvidoria@bytebank.com.br</Typography>
      </Box>
      <Box
        display={"flex"}
        flexDirection={"column"}
